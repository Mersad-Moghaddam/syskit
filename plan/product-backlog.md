...
| ID | Story | Pts | Sprint | Status | Spec / Ref |
|---|---|---|---|---|---|
| SYS-01 | `syskit system` — host, kernel, OS release, uptime, load averages. | 8 | 1 | Backlog | `../specs/features/system.md` |
| CPU-01 | `syskit cpu` — topology, model, cache, static identity. | 5 | 2 | Backlog | `../specs/features/cpu.md` |
...
| DOC-v01 | v0.1 user docs: getting-started build/install + command pages. | 3 | 3 | Backlog | `../docs/getting-started.md` |
...
| ID | Story | Pts | Sprint | Status | Spec / Ref |
|---|---|---|---|---|---|
| TUI-01 | Bubble Tea + Lip Gloss foundation (model/update/view, styling). | 8 | 7 | Backlog | `../specs/features/dashboard.md`, `../decisions/006-bubbletea-for-tui.md` |
...
| WCH-01 | `syskit watch <command> --interval` — continuous refresh. | 5 | 7 | Backlog | `../specs/features/dashboard.md`, `../specs/cli-conventions.md` |
...
| ID | Story | Pts | Sprint | Status | Spec / Ref |
|---|---|---|---|---|---|
| CG-01 | cgroup v1/v2 parsing in platform layer. | 13 | 10 | Backlog | `../specs/features/containers.md` |
| CNT-01 | Container-to-process mapping + container-aware process views. | 8 | 10 | Backlog | `../specs/features/containers.md` |
...
| ID | Story | Pts | Sprint | Status | Spec / Ref |
|---|---|---|---|---|---|
| PLG-01 | Plugin interface + out-of-process protocol definition. | 13 | 12 | Backlog | `../specs/plugin-architecture.md`, `../specs/features/plugins.md` |
| PLG-02 | Plugin discovery & loading mechanism. | 8 | 12 | Backlog | `../specs/plugin-architecture.md` |
...
| ID | Story | Pts | Sprint | Status | Spec / Ref |
|---|---|---|---|---|---|
| DIA-01 | `syskit diagnostics` — health checks, bottleneck detection. | 13 | 14 | Backlog | `../specs/features/diagnostics.md` |
...
| REL-01 | Release automation + changelog generation. | 5 | 14 | Backlog | `../docs/release-process.md`, `../standards/commit-conventions.md` |
