...
| ID | Story | Pts | Sprint | Status | Spec / Ref |
|---|---|---|---|---|---|
| PLG-01 | Plugin interface + out-of-process protocol definition. | 13 | 12 | Done | `../specs/plugin-architecture.md`, `../specs/features/plugins.md` |
| PLG-02 | Plugin discovery & loading mechanism. | 8 | 12 | Done | `../specs/plugin-architecture.md` |
| PLG-03 | Custom collector registration via plugins. | 5 | 12 | Done | `../specs/features/plugins.md` |
| PLG-04 | Plugin isolation & security model. | 8 | 13 | Done | `../specs/plugin-architecture.md`, `../SECURITY.md` |
| PLG-05 | Plugin configuration system. | 3 | 13 | Done | `../specs/configuration.md` |
| PLG-06 | Plugin SDK, example plugin, and authoring docs. | 5 | 13 | Done | `../specs/features/plugins.md` |
| REL-v05 | Release v0.5.0 — hardening, CHANGELOG, tag. | 3 | 13 | Done | `../docs/release-process.md` |
...
| PKG-01 | Packaging: deb, rpm, AUR, static binaries, checksums. | 8 | 14 | In Progress | `../docs/release-process.md` |
