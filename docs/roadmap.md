...
| v0.4 | Container-aware inspection and cgroup resource visibility | In progress (cgroup metrics, container-aware process filtering, cgroup-derived listing, and process inspection available) |
