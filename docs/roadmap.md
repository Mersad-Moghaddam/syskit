...
is in progress: filtering, process listing/tree, interface counters plus
state, MTU, MAC, route, and DNS views, TCP/UDP/IPv6/Unix port listing with
best-effort process ownership, and YAML output are available.
