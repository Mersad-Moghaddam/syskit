...
| v0.4 | Container-aware inspection and cgroup resource visibility | In progress (cgroup metrics, container-aware process filtering, and cgroup-derived container listing available) |
