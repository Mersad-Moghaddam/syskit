...
func TestCoreCommandGoldens(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{"cpu", func(format string) *cobra.Command {
			return NewCPUCmd(goldenCPUService{&model.CPUInfo{LogicalCores: 1, Model: "Fixture CPU", Architecture: "amd64", Times: []model.CPUTime{{CPUID: "all", User: 10, System: 5, Idle: 85, Total: 100, Utilization: &util}}}}, CPUOptions{Format: func() string { return format }, NoHeader: func() bool { return false }})
		}},
		{"memory", func(format string) *cobra.Command {
			return NewMemoryCmd(goldenMemoryService{&model.MemoryInfo{TotalBytes: 100, UsedBytes: &used, AvailableBytes: &available, FreeBytes: 10}}, MemoryOptions{Format: func() string { return format }, NoHeader: func() bool { return false }})
		}},
		{"disk", func(format string) *cobra.Command {
			return NewDiskCmd(goldenDiskService{&model.DiskInfo{Mounts: []model.MountInfo{{Source: "/dev/test", FilesystemType: "ext4", MountPoint: "/", TotalBytes: &total, UsedBytes: &used, AvailableBytes: &avail, UsePercent: &pct}}}}, DiskOptions{Format: func() string { return format }, NoHeader: func() bool { return false }})
		}},
		{"filesystem", func(format string) *cobra.Command {
			...
			return NewFilesystemCmd(goldenDiskService{&model.DiskInfo{Mounts: []model.MountInfo{mount}}}, FilesystemOptions{Format: func() string { return format }, NoHeader: func() bool { return false }})
		}},
	} {
